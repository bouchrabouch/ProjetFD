...
namespace ProjetFD
{
    public partial class M3 : Form
    {
        ...
        public void displayData()
        {
            ...
            cmd.CommandText = "select * from M3";
            cmd.ExecuteNonQuery();
        ...
        {
            con.Open();
            cmd = new SqlCommand("insert into M3 values ('" + comboBox2.Text + "','" + comboBox1.Text + "','" + textBox1.Text + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "')", con);
            cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from M3 where tradename = '" + comboBox1.Text + "' ";
            cmd.ExecuteNonQuery();
            con.Close();
            displayData();
            clear();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                cmd = new SqlCommand("update M3 set tradename = '" + comboBox1.Text + "',Quantity ='" + textBox1.Text + "',TodaySDate = '" + dateTimePicker1.Value.ToString() + "' where CodeProduct = '" + comboBox2.Text + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
                displayData();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from M3  where tradename= '" + comboBox1.Text + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter("select distinct CodeProduct from drugPED where tradename = '" + comboBox1.Text + "'", conn);
            DataTable DT = new DataTable();
            sda.Fill(DT);
        ...
        {
            {
                SqlDataAdapter SDA = new SqlDataAdapter("SELECT DISTINCT tradename FROM drugPED", conn);
                DataTable DT = new DataTable();
                SDA.Fill(DT);
