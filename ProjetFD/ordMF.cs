...
namespace ProjetFD
{
    public partial class ordMF : Form
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=UTILISA-6T0ALDK\SQLEXPRESS;Initial Catalog=ordo9;Integrated Security=True");
        SqlCommand cmd;
        ...
        private void ordMF_Load(object sender, EventArgs e)
        {
        ...
        public void GetName()
        {
            SqlConnection connn = new SqlConnection(@"Data Source=UTILISA-6T0ALDK\SQLEXPRESS;Initial Catalog=Youtube130 ;Integrated Security=True");


            connn.Open();
            string Query = "select * from serMF1 where N = " + comboBox3.SelectedValue.ToString() + "";
        ...
        public void GetN()
        {
            ...
            connn.Open();
            SqlCommand cmdd = new SqlCommand("select N from serMF1", connn);
            SqlDataReader rdr;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn.Open();
                cmd = new SqlCommand("insert into ordo9_new values ('" + dateTimePicker1.Value.ToString("yyy-MM-dd") + "', '" + comboBox1.Text + "','" + comboBox2.Text + "','" + comboBox3.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + dateTimePicker2.Value.ToString("yyy-MM-dd") + "','" + textBox1.Text + "')", conn);
                cmd.ExecuteNonQuery();
        ...
        public void displayData()
        {
            ...
            cmd.CommandText = "select * from ordo9_new";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from ordo9_new where Name = '" + textBox2.Text + "' ";
            cmd.ExecuteNonQuery();
            conn.Close();
            displayData();
            clear();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                cmd = new SqlCommand("update ordo9_new set Date = '" + dateTimePicker1.Value.ToString("yyy-MM-dd") + "' ,Doctor= '" + comboBox1.Text + "',service ='" + comboBox2.Text + "',Name  = '" + textBox2.Text + "',LastName = '" + textBox3.Text + "', Medicines= '" + textBox4.Text + "',DateOfBirth ='" + dateTimePicker2.Value.ToString("yyy-MM-dd") + "',NInsuranceCard = '" + textBox1.Text + "'   where N = '" + comboBox3.Text + "'  ", conn);
                cmd.ExecuteNonQuery();
                conn.Close();
                displayData();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from ordo9_new where NInsuranceCard= '" + textBox1.Text + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
