...
namespace ProjetFD
{
    public partial class M1 : Form
    {
        ...
        {
            SqlDataAdapter SDA = new SqlDataAdapter("SELECT DISTINCT tradename FROM UMS0_new", conn);
        ...
        public void Data()
        {
            ...
            cmdd.CommandText = "select * from UMS0_new ";
        ...
        public void displayData()
        {
            ...
            cmd.CommandText = "select * from M1";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
        ...
        {
            con.Open();
            cmd = new SqlCommand("insert into M1 values ('" + comboBox2.Text + "','" + comboBox1.Text + "','" + textBox1.Text + "','" + dateTimePicker1.Value.ToString("yyyy-MM-dd") + "')", con);
            cmd.ExecuteNonQuery();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from M1 where tradename = '" + comboBox1.Text + "' ";
            cmd.ExecuteNonQuery();
            con.Close();
            displayData();
            clear();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                cmd = new SqlCommand("update M1 set tradename = '" + comboBox1.Text + "',Quantity ='" + textBox1.Text + "',TodaySDate = '" + dateTimePicker1.Value.ToString() + "' where CodeProduct = '" + comboBox2.Text + "'", con);
                cmd.ExecuteNonQuery();
                con.Close();
                displayData();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from M1  where tradename= '" + comboBox1.Text + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter("select distinct CodeProduct from UMS0_new where tradename = '" + comboBox1.Text + "'", conn);
            DataTable DT = new DataTable();
            sda.Fill(DT);
