...
namespace ProjetFD
{
    public partial class P011 : Form
    {
        ...
        private void P011_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (r.IsMatch(textBox5.Text))
            {
                ...
                else
                {
                    ...
                    conn.Open();
                    cmd = new SqlCommand("insert into CC11 values ('" + dateTimePicker1.Value.ToString("yyy-MM-dd") + "', '" + comboBox1.Text + "','" + comboBox2.Text + "','" + comboBox3.Text + "','" + textBox2.Text + "','" + textBox3.Text + "','" + textBox4.Text + "','" + textBox5.Text + "','" + dateTimePicker2.Value.ToString("yyy-MM-dd") + "','" + textBox1.Text + "')", conn);
                    cmd.ExecuteNonQuery();
        ...
        public void displayData()
        {
            ...
            cmd.CommandText = "select * from CC11";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (r.IsMatch(textBox5.Text))
            {
                ...
                {
                    conn.Open();
                    cmd = new SqlCommand("update CC11 set Date = '" + dateTimePicker1.Value.ToString("yyy-MM-dd") + "' ,Doctor= '" + comboBox1.Text + "',service ='" + comboBox2.Text + "',Name  = '" + textBox2.Text + "',LastName = '" + textBox3.Text + "', Sickness= '" + textBox4.Text + "',DateOfBirth ='" + dateTimePicker2.Value.ToString("yyy-MM-dd") + "',NInsuranceCard = '" + textBox1.Text + "',Telephonenumber = '" + textBox5.Text + "'  where N = '" + comboBox3.Text + "' ", conn);
                    cmd.ExecuteNonQuery();
                    conn.Close();
                    displayData();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "delete from CC11 where Name = '" + textBox2.Text + "' ";
            cmd.ExecuteNonQuery();
            conn.Close();
            displayData();
            clear();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = "select * from CC11 where NInsuranceCard= '" + textBox1.Text + "' ";
            cmd.ExecuteNonQuery();
            DataTable dt = new DataTable();
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            da.Fill(dt);
